...
/// Landscape URGENT block: inherits category block design with a RED header.
  ...
  return Container(
    ...
    child: Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Red URGENT header (same shape as category header but red)
          Container(
            padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 3),
            decoration: BoxDecoration(
...
/// Portrait variant of URGENT block - same category block design with red header.
